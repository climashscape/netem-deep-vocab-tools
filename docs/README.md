...
欢迎查阅 NETEM Deep Vocab Tools 的文档库。以下是各类文档的索引：

## 📚 核心文档

*   [**ROADMAP.md**](../ROADMAP.md): 项目长期规划与愿景。
*   [**CODE_OF_CONDUCT.md**](../CODE_OF_CONDUCT.md): 社区行为准则。
*   [**CONTRIBUTING.md**](../CONTRIBUTING.md): 简要的贡献说明 (将被详细指南取代)。

## 🛠 开发指导 (Guidelines)

为了确保项目质量与一致性，请开发者务必阅读以下规范：
...
> 如有任何文档缺失或错误，请提交 Issue 或 PR 进行修正。
